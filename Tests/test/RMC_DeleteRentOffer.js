...
contract('RentalMainContract', function (accounts) {
  ...
  describe("DESCRIBE: Should delete a placed rent offer by hash", async () => {
    ...
    it("should delete an existing rent offer", async () => {
      
      console.log("Going to delete the offer: " + rentOfferHash)
      var response = await demoContract.deleteRentOffer(rentOfferHash);
